...
Create a structured handoff file capturing your current work state. Use this before ending a session so you (or someone else) can pick up exactly where you left off. Pairs with `/EA-pickup`.
...
3. **Generate filename**
   ...
   - Example: `001-2026-01-24-github-setup.md`
...
6. **Confirm creation**
   ...
   - Remind user to run `/EA-pickup` in next session
...
To resume: Run `/EA-pickup` in your next session
```
