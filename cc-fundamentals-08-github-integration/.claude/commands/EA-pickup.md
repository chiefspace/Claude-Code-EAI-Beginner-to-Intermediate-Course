...
Resume work from a previous session by reading the most recent handoff file. Provides context summary and next steps so you can continue seamlessly. Pairs with `/EA-handoff`.
...
When `/EA-pickup list` is run:

```
Available Handoffs

001-2026-01-20-initial-setup.md
002-2026-01-21-github-app.md
003-2026-01-24-testing.md  ← Most Recent

To load a specific handoff: /EA-pickup 2
To load most recent: /EA-pickup
```
